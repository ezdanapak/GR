...
var features_testregionebi_0 = format_testregionebi_0.readFeatures(json_testregionebi_0, { dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32638' });
...
lyr_testregionebi_0.set('fieldAliases', { 'saxeli': 'saxeli', 'saxeli_en': 'saxeli_en', 'Area_kv_km': 'Area_kv_km', 'Area_ha': 'Area_ha', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_testregionebi_0.set('fieldImages', { 'saxeli': 'TextEdit', 'saxeli_en': 'TextEdit', 'Area_kv_km': 'TextEdit', 'Area_ha': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_testregionebi_0.set('fieldLabels', { 'saxeli': 'no label', 'saxeli_en': 'no label', 'Area_kv_km': 'no label', 'Area_ha': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
